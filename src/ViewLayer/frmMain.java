...
public class frmMain extends javax.swing.JFrame {
    ...
    private frmProductos objProd = new frmProductos();
    private frmFarmacias objFarma = new frmFarmacias();
    ...
    private void btnFarmaciasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFarmaciasActionPerformed
        ControlVentanas(objFarma);
    }//GEN-LAST:event_btnFarmaciasActionPerformed

    public void ControlVentanas(JInternalFrame frame) {
        boolean open = true;
        for (int i = 0; i < desktopPane.getComponentCount(); i++) {
            if (frame.getClass().isInstance(desktopPane.getComponent(i))) {
                frame.toFront();
        ...
        if (open) {
            ...
            Dimension tamañoFrame = objFarma.getSize();
            objFarma.setLocation((desk.width - tamañoFrame.width) / 2, (desk.height - tamañoFrame.height) / 2);
        }
        frame.show();
    }
